...
const ContentData =[
  {
    Title:"من نحن",
    Description:"شركة عندك هي منصة سعودية مبتكرة تهدف إلي تقديم حلول توصيل متكاملة باستخدام أحدث التقنيات اللوجستية. تأسست الشركة علي رؤية   وطموح     لتوفير  تجربة سلسة وفعالة للتجار والعملاء من خلال توفير خدمات توصيل سريعة وموثوقة."
  },
  {
    Title:"رؤيتنا",
...
<section className="" dir="rtl">
  ...
  >
    <div data-aos="fade-up" data-aos-duration="1000">
      ...
      <p className="max-w-3xl mx-auto mt-4 text-xl text-center ">شركة "عندك" هي منصة سعودية مبتكرة تهدف إلي تقديم حلول توصيل متكاملة باستخدام أحدث التقنيات اللوجستية. تأسست الشركة علي رؤية   وطموح     لتوفير  تجربة سلسة وفعالة للتجار والعملاء من خلال توفير خدمات توصيل سريعة وموثوقة.       </p>
    </div>
