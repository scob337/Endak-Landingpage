...
const ServicesData = [
  ...
  },
  {
    ...
    Description:
      " نقدم  نموذج  تسعير عادل يعزز من شراكتنا مع التجار, حيث نوفر عمولات منخفضة للمحلات التجارية التي تضمن أسعاراً عادلة لعملائها",
  },
  {
  ...
  },
  {
    ...
    Description:
      " نواصل توسيع نطاق خدماتنا لتغطية مناطق أوسع, مع خطط لتطوير تقنيات جديدة تلبي احتياجات السوق المتنامي.",
  },
];
        ...
        <div className="container px-5 py-10 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            ...
            <p className="text-right text-[18px] font-semibold title-font text-gray-900">
              تأسست شركة عندك لخدمات الأعمال برؤية   وطموح     تهدف  إلي تطوير قطاع التوصيل في المملكة العربية السعودية...
            </p>
          </div>
