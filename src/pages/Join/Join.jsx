...
const Join = () => {
  ...
  return (
    <main
      ...
      className="flex  w-full flex-col items-center justify-center text-center px-4  md:h-screen "
      dir="rtl"
    >
      <Helmet>
        <title> شركة عندك | انضم إلينا وكن جزءًا من ثورة التوصيل الذكي</title>
        <meta
          name="description"
          content="انضم إلى فريق عمل شركة عندك وكن جزءًا من مستقبل التوصيل الذكي نوفر فرص عمل متميزة في بيئة عمل مرنة ومبتكرة. اكتشف الوظائف المتاحة وقدّم طلبك اليوم"
        />
      </Helmet>
      ...
      <p className="mx-auto mt-12 max-w-xl text-lg text-slate-700 leading-7">
        هل ترغب في أن تكون جزءًا من فريقنا؟ نحن نوفر فرص عمل متميزة في بيئة عمل
        مرنة ومبتكرة.
      </p>
